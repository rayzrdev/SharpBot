...
exports.run = function (bot, msg) {
    ...
    const millisJoined = new Date().getTime() - msg.member.joinedAt.getTime();
    ...
    let embed = bot.utils.embed(
        ...
        ***This message will dissappear in 30 seconds.***`,
        [
            ...
            {
                name: 'Game',
                value: `${(msg.mentions.users.first().presence.game && msg.mentions.users.first().presence.game && msg.mentions.users.first().presence.game.name) || 'Not playing a game.'}`,
            },
            {
                name: 'Created On',
            ...
            { 
                name: 'Joined On',
                value: `${dateFormat(user.joinedTimestamp)}`,
            },
            {
